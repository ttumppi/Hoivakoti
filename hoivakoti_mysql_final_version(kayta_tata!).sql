...
--
-- Host: localhost
-- Generation Time: 03.12.2022 klo 08:41
...
--
-- AUTO_INCREMENT for table `osoite`
--
ALTER TABLE `osoite`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `asukkaat`
  ADD CONSTRAINT `asukkaat_ibfk_1` FOREIGN KEY (`osoite_id`) REFERENCES `osoite` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Rajoitteet taululle `osoite`
--
ALTER TABLE `osoite`
  ADD CONSTRAINT `osoite_ibfk_1` FOREIGN KEY (`Id`) REFERENCES `sopimus` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Rajoitteet taululle `palvelukori`
--
ALTER TABLE `palvelukori`
